...
//?} else {
/*    @Override
    protected void applyRotations(T entity, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
        super.applyRotations(entity, poseStack, ageInTicks, rotationYaw, partialTick);
*/
//?}
        if (entity instanceof FroggyTamedEntity tamed && tamed.isSleepingInBed()) {
